...
<?php if(!empty($GLOBALS['reg_error'])) { 
	echo "<body class='overflow-h'>";
} else {
	echo "<body>";
}?>
	<?php if ( ! is_user_logged_in() ) do_action( 'create_reg_form' ); ?>
	<div class="container p-0">
		<header class="header">
			<?php 
				do_action( 'check_user_login' );
			?>
